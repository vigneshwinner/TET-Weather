...
def process_eia_deltas(lookback_years: int = 5) -> pd.DataFrame:
    """
...
def get_eia_deltas(lookback_years: int = 5) -> pd.DataFrame:
    """
    ...
    """
    return process_eia_deltas(lookback_years)


if __name__ == "__main__":
    df = process_eia_deltas()
