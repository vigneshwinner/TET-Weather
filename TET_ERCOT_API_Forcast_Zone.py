...
TARGET_EMIL_ID = "NP6-346-CD"  # Actual System Load by Weather Zone
TARGET_ARTIFACT_NAME = "act_sys_load_by_fzn"  # the endpoint path
...
# -----------------------------
if all_rows:
    out = "ercot_last_60_forecast_zone.csv"
